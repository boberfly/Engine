...
namespace GPU
{
	VLKDescriptorHeapAllocator::VLKDescriptorHeapAllocator(ID3D12Device* device,
	...
	VLKDescriptorHeapAllocator::~VLKDescriptorHeapAllocator() {}
	...
	VLKDescriptorAllocation VLKDescriptorHeapAllocator::Alloc(i32 numCBV, i32 numSRV, i32 numUAV)
	{
	...
	void VLKDescriptorHeapAllocator::Free(D3D12DescriptorAllocation alloc)
	{
		Core::ScopedMutex lock(allocMutex_);
	...
	void VLKDescriptorHeapAllocator::FreeAll()
	{
		Core::ScopedMutex lock(allocMutex_);
	...
	void VLKDescriptorHeapAllocator::AddBlock()
	{
	...
	void VLKDescriptorHeapAllocator::ConsolodateAllocations()
	{
	...
	void VLKDescriptorHeapAllocator::ClearRange(
