...
namespace GPU
{
	VLKLinearHeapAllocator::D3D12LinearHeapAllocator(
	...
	VLKLinearHeapAllocator::~VLKLinearHeapAllocator() {}

	VLKResourceAllocation VLKLinearHeapAllocator::Alloc(i64 size, i64 alignment)
	{
		DBG_ASSERT(size > 0);
	...
	void VLKLinearHeapAllocator::Reset()
	{
		Core::ScopedMutex lock(allocMutex_);
	...
	VLKLinearHeapAllocator::ResourceBlock VLKLinearHeapAllocator::CreateResourceBlock(i64 size)
	{
